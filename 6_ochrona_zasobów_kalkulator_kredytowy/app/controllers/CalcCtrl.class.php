...
global $user;
	...
	if ($user->role == "admin") {
	if ( $this->form->oproc < 1 || $this->form->oproc > 99) 
	{
		getMessages()->addError('Zły przedział dla oprocentowania od 1 do 99');
	}}
	else {
	if ( $this->form->oproc < 5 || $this->form->oproc > 20) 
	{
		getMessages()->addError('Zły przedział dla oprocentowania od 5 do 20');
	}
	}
}
